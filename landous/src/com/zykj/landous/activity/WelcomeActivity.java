...
public class WelcomeActivity extends BaseActivity implements OnGestureListener,
	...
	void initLayout() {
		...
		frameLayoutParams = (FrameLayout.LayoutParams) layer_image_two
				.getLayoutParams();
		frameLayoutParams.height = dm.heightPixels;
		frameLayoutParams.width = dm.widthPixels;
		...
		frameLayoutParams = (FrameLayout.LayoutParams) layer_image_three
				.getLayoutParams();
		frameLayoutParams.height = dm.heightPixels;
		frameLayoutParams.width = dm.widthPixels;
		...
		frameLayoutParams = (FrameLayout.LayoutParams) layer_image_four
				.getLayoutParams();
		frameLayoutParams.height = dm.heightPixels;
		frameLayoutParams.width = dm.widthPixels;
		...
		frameLayoutParams = (FrameLayout.LayoutParams) layer_image_five
				.getLayoutParams();
		frameLayoutParams.height = dm.heightPixels;
		frameLayoutParams.width = dm.widthPixels;
